...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { dtype_id: @degree.dtype_id, name: @degree.name } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { dtype_id: @degree.dtype_id, name: @degree.name } }
